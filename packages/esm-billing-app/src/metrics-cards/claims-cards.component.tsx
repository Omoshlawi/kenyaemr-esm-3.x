    ...
    <Layer className={styles.cardContainer}>
      <Tile className={styles.tile}>
        ...
        <div className={styles.cardBody}>
          {total !== undefined && <p className={styles.mainCount}>{total}</p>}
    ...
    <section className={styles.container}>
      ...
      <div className={styles.cardsRow}>
        <ClaimsMetricCard
          ...
          items={[]}
        />
        <ClaimsMetricCard title={t('emrSide', 'EMR Side')} items={providerItems} />
        <ClaimsMetricCard title={t('payerSide', 'Payer Side')} items={payerItems} />
      </div>
    </section>
  );
}
