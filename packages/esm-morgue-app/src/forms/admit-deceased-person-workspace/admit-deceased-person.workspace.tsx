...
import { EnhancedPatient, type MortuaryLocationResponse } from '../../types';
...
const AdmitDeceasedPerson: React.FC<Workspace2DefinitionProps<AdmitDeceasedPersonProps, object, object>> = ({
  closeWorkspace,
  workspaceProps: { patient, mortuaryLocation, mutated, deceasedPatientUuid, queueEntryUuid },
}) => {
