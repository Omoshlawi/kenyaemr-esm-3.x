...
export const MCH_PARTOGRAPHY_ENCOUNTER_UUID =
  _partoUuids.mchPartographyEncounterUuid ?? 'd14dde5b-95dc-40a1-8ff0-acad34fb58b2';

export const CONTRACTION_STRONG_UUID =
  _partoUuids.contractionStrongConceptUuid ?? '4b90b73a-ad11-4650-91b0-baea131974e0';

export const SURGICAL_PROCEDURE_UUID = '1810AAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAA';
...
export const POST_OPERATIVE_SUMMARY_ENCOUNTER_UUID = 'd14dde5b-95dc-40a1-8ff0-acad34fb58b2';

export const PARTOGRAPHY_ENCOUNTER_TYPES = {
  ...Object.fromEntries(
    PARTOGRAPHY_GRAPH_TYPES.filter((type) => type !== 'post-operative-summary').map((type) => [
      type,
      MCH_PARTOGRAPHY_ENCOUNTER_UUID,
    ]),
  ),
  'post-operative-summary': POST_OPERATIVE_SUMMARY_ENCOUNTER_UUID,
...
export const PARTOGRAPHY_UNITS = {
  ...
  'maternal-pulse': 'BPM',
  'blood-pressure': 'mmHg',
  'pulse-bp-combined': 'mmHg',
  temperature: '°C',
  'urine-analysis': 'Level',
  'drugs-fluids': 'ml/hr',
  'progress-events': 'Value',
  'post-operative-summary': 'Value',
} as const;
...
export const IV_FLUIDS_OPTIONS = [
  { id: '', text: 'Choose an option', conceptUuid: '' },
  { id: 'ringer-lactate', text: "Ringer's lactate", conceptUuid: '78617AAAAAAAAAAAAAAAAAAAAAAAAAAAAAAA' },
  { id: 'normal-saline', text: 'Sodim Chloride', conceptUuid: '80804AAAAAAAAAAAAAAAAAAAAAAAAAAAAAAA' },
  { id: 'dextrose-5-water', text: 'Dextrose 5% in water', conceptUuid: '161250AAAAAAAAAAAAAAAAAAAAAAAAAAAAAA' },
  { id: 'dextran', text: 'Dextran', conceptUuid: '74653AAAAAAAAAAAAAAAAAAAAAAAAAAAAAAA' },
  { id: 'dextrose-10-water', text: 'Dextrose 10% in water', conceptUuid: '161922AAAAAAAAAAAAAAAAAAAAAAAAAAAAAA' },
  {
    id: 'dextrose-5-normal-saline',
    text: 'Dextrose 5% in normal saline',
    conceptUuid: '162857AAAAAAAAAAAAAAAAAAAAAAAAAAAAAA',
  },
  {
    id: 'kcl-20-normal-saline',
    text: 'Potassium chloride 20 mmol/L in normal saline',
    conceptUuid: '162855AAAAAAAAAAAAAAAAAAAAAAAAAAAAAA',
  },
  {
    id: 'kcl-40-sodium',
    text: 'Potassium chloride 40 mmol/sodium',
    conceptUuid: '162856AAAAAAAAAAAAAAAAAAAAAAAAAAAAAA',
  },
  {
    id: 'glucose50-sodium-chloride',
    text: 'Glucose 50 MG/ML / Sodium Chloride',
    conceptUuid: '162859AAAAAAAAAAAAAAAAAAAAAAAAAAAAAA',
  },
  {
    id: 'mono-potassium-phosphate-sodium-phosphate',
    text: 'Monopotassium phosphate 0.259% / sodium phosphate',
    conceptUuid: '162860AAAAAAAAAAAAAAAAAAAAAAAAAAAAAA',
  },
  {
    id: 'sodium-bicarbonate',
    text: 'Sodium bicarbonate 1.26% injection solution',
    conceptUuid: '162861AAAAAAAAAAAAAAAAAAAAAAAAAAAAAA',
  },
] as const;
