...
export const SCREENING_FIELDS = {
  bloodGroup: { kind: 'coded', label: 'Blood Group', rendering: 'radio' },
  hivStatus: { kind: 'coded', label: 'HIV Status', rendering: 'radio' },
  hepatitisCStatus: { kind: 'coded', label: 'Hepatitis C Status', rendering: 'radio' },
  hepatitisBStatus: { kind: 'coded', label: 'Hepatitis B Status', rendering: 'radio' },
  syphilisStatus: { kind: 'coded', label: 'Syphilis Status', rendering: 'radio' },
...
export const INITIAL_PRE_DIALYSIS_FIELDS = {
  ...
  temperature: {
    ...
    max: 43,
    units: '°C',
    helperText: 'Body temperature (25–43 °C; server may enforce 35–43 °C)',
  },
  respiratoryRate: {
    kind: 'numeric',
  ...
  oxygenSaturation: {
    ...
    max: 100,
    units: '%',
    helperText: 'SpO₂ (0–100%). Server may enforce 50–100%.',
  },
  bloodSugar: {
    kind: 'numeric',
